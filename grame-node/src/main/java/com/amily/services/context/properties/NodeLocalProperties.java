...
public class NodeLocalProperties {
	...
	public void reload() {
		...
		activeProfile = properties.getProfileProperty("grame.profiles.active");
		...
		recordLogDir = properties.getStringProperty("grame.recordStream.logDir");
		recordLogPeriod = properties.getLongProperty("grame.recordStream.logPeriod");
		recordStreamEnabled = properties.getBooleanProperty("grame.recordStream.isEnabled");
		recordStreamQueueCapacity = properties.getIntProperty("grame.recordStream.queueCapacity");
		...
		accountsExportPath = properties.getStringProperty("grame.accountsExportPath");
		exportAccountsOnStartup = properties.getBooleanProperty("grame.exportAccountsOnStartup");
