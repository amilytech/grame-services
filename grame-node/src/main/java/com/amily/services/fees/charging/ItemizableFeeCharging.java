...
import static com.grame.services.fees.TxnFeeType.*;

/**
 * A {@link FieldSourcedFeeScreening} which also implements
 * {@link TxnScopedFeeCharging} via an injected {@link grameLedger}.
 * Keeps a history of per-transaction fees charging activity to
 * make it easy to construct the final {@link com.gramegrame.api.proto.java.TransactionRecord}.
 *
 * @author AmilyTech
 */
