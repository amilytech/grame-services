...
import com.grame.services.legacy.exception.KeySignatureTypeMismatchException;
...
import com.grame.services.txns.validation.TransferListChecks;
...
import static com.grame.services.utils.MiscUtils.activeHeaderFrom;
...
import static com.gramegrame.api.proto.java.ResponseType.COST_ANSWER_STATE_PROOF;
...
public class TransactionHandler {
  ...
  public ResponseCodeEnum nodePaymentValidity(Transaction signedTxn, long queryFee) {
    try {
      var txn = com.grame.services.legacy.proto.utils.CommonUtils.extractTransactionBody(signedTxn);
  ...
  public ResponseCodeEnum validateQuery(Query query, boolean hasPayment) {
    ...
    try {
      body = com.grame.services.legacy.proto.utils.CommonUtils.extractTransactionBody(feePayment);
    } catch (Exception e) {
      return INVALID_TRANSACTION_BODY;
    }
