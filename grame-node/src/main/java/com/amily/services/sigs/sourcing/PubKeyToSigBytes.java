...
import static com.grame.services.legacy.proto.utils.CommonUtils.extractSignatureMapOrUseDefault;
...
public interface PubKeyToSigBytes {
	 ...
	 * list of cryptographic signatures contained in a list of grame
	 * {@link Signature} instances.
	 *
	 * @param grameSigs a list of grame {@link Signature} objects.
	 * @return a source of the raw signatures contained in the grame signatures.
	 */
	static PubKeyToSigBytes from(List<Signature> grameSigs) {
		return new SigListPubKeyToSigBytes(grameSigs);
	}
