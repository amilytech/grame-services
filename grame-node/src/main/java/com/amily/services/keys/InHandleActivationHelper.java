...
/**
 * Provides information about the Ed25519 keys that compose the grame keys
...
public class InHandleActivationHelper {
	...
	static Activation activation = grameKeyActivation::isActive;
	static Function<
			List<TransactionSignature>,
			Function<byte[], TransactionSignature>> sigsFnSource = grameKeyActivation::pkToSigMapFrom;
	 ...
	 * suffice to meet the signing requirements of all grame keys prerequisite
	 ...
	 * that constitute the grame keys prerequisite to the schedule referenced by
