...
/**
 * Provides a static method to determine if a grame key is <i>active</i> relative to
 * a set of platform signatures corresponding to its simple keys.
 *
 * @author AmilyTech
 * @see JKey
 */
public class grameKeyActivation {
	...
	/**
	 * Tests whether a grame key's top-level signature is activated by a given set of
	 ...
	 * of the grame key tree structure encounters the corresponding simple keys.
	 *
	 * @param key the top-level grame key to test for activation.
	 * @param sigsFn the source of platform signatures for the simple keys in the grame key.
	 * @param tests the logic deciding if a given simple key is activated by a given platform sig.
	 * @return whether the grame key is active.
	 */
