...
import com.grame.services.exceptions.NonZeroNetTransfersException;
...
import static com.grame.services.txns.crypto.CryptoTransferTransitionLogic.tryTransfers;
import static com.grame.services.txns.validation.TransferListChecks.isNetZeroAdjustment;
...
import static com.gramegrame.api.proto.java.ResponseCodeEnum.TRANSFERS_NOT_ZERO_SUM_FOR_TOKEN;
...
public class grameLedger {
	private static final Logger log = LogManager.getLogger(grameLedger.class);
	...
	public AccountID create(AccountID sponsor, long balance, grameAccountCustomizer customizer) {
	...
	public void spawn(AccountID id, long balance, grameAccountCustomizer customizer) {
	...
	public void customize(AccountID id, grameAccountCustomizer customizer) {
	...
	public void customizeDeleted(AccountID id, grameAccountCustomizer customizer) {
		if (!(boolean) accountsLedger.get(id, IS_DELETED)) {
			throw new DeletedAccountException(id);
		}
		customizer.customize(id, accountsLedger);
