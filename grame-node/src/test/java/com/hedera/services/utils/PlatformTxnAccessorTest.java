...
public class PlatformTxnAccessorTest {
	...
	public void extractorReturnsNoneWhenExpected() {
		// expect:
		assertEquals(grameFunctionality.NONE, SignedTxnAccessor.functionExtractor.apply(someTxn));
	}
	...
	public void usesExtractorToGetFunctionAsExpected() {
		...
		Function<TransactionBody, grameFunctionality> mockFn =
				(Function<TransactionBody, grameFunctionality>)mock(Function.class);
