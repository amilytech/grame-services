...
import static com.grame.services.sigs.factories.PlatformSigFactory.*;
...
public class PlatformSigFactoryTest {
	...
	public static String DATA = "Not really a grame GRPCA transaction!";
	public static String DIFFERENT_DATA = "NOT really a grame GRPCA transaction!";
