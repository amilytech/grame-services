...
import com.grame.services.legacy.unit.handler.CryptoHandlerTestHelper;
import com.grame.services.legacy.util.ComplexKeyManager;
import com.gramegrame.api.proto.java.AccountAmount;
import com.gramegrame.api.proto.java.AccountID;
import com.gramegrame.api.proto.java.CryptoTransferTransactionBody.Builder;
...
public class TransferListSizeTest {
  ...
  public TransactionReceipt transfer(Transaction transaction) throws Throwable {
    log.info("\n-----------------------------------\ntransfer: request = " +
            com.grame.services.legacy.proto.utils.CommonUtils.toReadableString(transaction));
    TransactionBody txBody =
        com.grame.services.legacy.proto.utils.CommonUtils.extractTransactionBody(transaction);
  ...
  private Transaction createSignedTransferTx(AccountID payerID, AccountID nodeID, AccountID[] accs,
    ...
    com.gramegrame.api.proto.java.TransactionBody.Builder txBodyBuilder =
        CommonUtils.extractTransactionBody(transferTx).toBuilder();
    Builder transferListBuilder =
        com.gramegrame.api.proto.java.CryptoTransferTransactionBody.newBuilder();
  ...
  protected Transaction getSignedTransferTx(Transaction unSignedTransferTx) throws Exception {
    TransactionBody txBody =
            com.grame.services.legacy.proto.utils.CommonUtils.extractTransactionBody(unSignedTransferTx);
    com.gramegrame.api.proto.java.CryptoTransferTransactionBody.Builder bodyBuilder =
