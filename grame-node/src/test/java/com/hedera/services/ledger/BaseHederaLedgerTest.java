...
public class BasegrameLedgerTest {
	...
	protected grameLedger subject;

	protected grameTokenStore tokenStore;
	...
	protected grameAccountCustomizer noopCustomizer = new grameAccountCustomizer();
	...
	protected void addToLedger(
			AccountID id,
			long balance,
			grameAccountCustomizer customizer,
	...
	protected void addDeletedAccountToLedger(AccountID id, grameAccountCustomizer customizer) {
	...
	protected void setupWithMockLedger() {
		...
		tokenStore = mock(grameTokenStore.class);
