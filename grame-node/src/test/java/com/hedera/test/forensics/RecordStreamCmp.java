...
import com.grame.test.forensics.domain.PojoRecord;
import com.grame.test.forensics.records.RecordParser;
...
import static com.grame.test.forensics.records.RecordParser.TxnHistory;
...
public class RecordStreamCmp {
	...
	static final String firstIssRoundAccounts = "/Users/tinkerm/Dev/iss/stable/node00-logs/" +
			"data/saved/com.grame.services.ServicesMain/0/accounts-round38056100.fcm";
	/*
