...
import com.grame.test.forensics.domain.PojoFs;
import com.grame.test.forensics.domain.PojoLedger;
...
public class FcmToJsonUtil {
	final List<String> accountsLocs = List.of(new String[] {
			"/Users/tinkerm/Dev/iss/stable/node00-logs/data/saved/com.grame.services" + ".ServicesMain/0/accounts-round38056100.fcm",
//			"/Users/tinkerm/Dev/iss/stable/node00-logs/data/saved/com.grame.services" +
//					".ServicesMain/0/accounts-round38056101.fcm"
	});
	final List<String> storageLocs = List.of(
			"/Users/tinkerm/Dev/hgn2/services-grame/grame-node/forensics/iss-demo/0/storage-round12.fcm",
			"/Users/tinkerm/Dev/hgn2/services-grame/grame-node/forensics/iss-demo/1/storage-round12.fcm",
			"/Users/tinkerm/Dev/hgn2/services-grame/grame-node/forensics/iss-demo/2/storage-round12.fcm"
	);
	final List<String> topicsLocs = List.of(
			"/Users/tinkerm/Dev/hgn2/services-grame/grame-node/forensics/iss-demo/0/topics-round12.fcm",
			"/Users/tinkerm/Dev/hgn2/services-grame/grame-node/forensics/iss-demo/1/topics-round12.fcm",
			"/Users/tinkerm/Dev/hgn2/services-grame/grame-node/forensics/iss-demo/2/topics-round12.fcm"
	);

	@Test
	void convertStorageToJson() throws Exception {
		String[] round60Locs = {
//				"/Users/tinkerm/Dev/hgn3/grame-services/grame-node/n0-storage-round60.fcm",
				"/Users/tinkerm/Dev/hgn3/grame-services/grame-node/n1-storage-round60.fcm",
//				"/Users/tinkerm/Dev/hgn3/grame-services/grame-node/n2-storage-round60.fcm",
//				"/Users/tinkerm/Dev/hgn3/grame-services/grame-node/n3-storage-round60.fcm",
		};
