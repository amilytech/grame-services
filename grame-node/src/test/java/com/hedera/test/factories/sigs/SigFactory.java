...
import com.grame.test.factories.keys.KeyTreeLeaf;
import com.grame.test.factories.keys.KeyTreeListNode;
import com.grame.test.factories.keys.KeyTreeNode;
import com.grame.test.factories.keys.KeyTreeThresholdNode;
import com.gramegrame.api.proto.java.Key;
import com.gramegrame.api.proto.java.Signature;
import com.gramegrame.api.proto.java.SignatureList;
import com.gramegrame.api.proto.java.ThresholdSignature;
import com.gramegrame.api.proto.java.Transaction;
import com.grame.services.legacy.proto.utils.SignatureGenerator;
...
import static com.grame.services.legacy.proto.utils.CommonUtils.extractTransactionBodyBytes;
import static com.grame.services.legacy.proto.utils.SignatureGenerator.signBytes;
...
public class SigFactory {
	...
	private Signature asgrameSignature(KeyTreeNode node, byte[] data, KeyFactory factory) {
											...
											SignatureList.newBuilder()
													.addAllSigs(
														thresholdNode.getChildren().stream()
																.map(child -> asgrameSignature(child, data, factory))
																.collect(toList())
													).build()
									).build()
					).build();
